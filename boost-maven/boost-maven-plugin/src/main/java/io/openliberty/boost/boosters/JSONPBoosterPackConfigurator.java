...
public class JSONPBoosterPackConfigurator implements BoosterPackConfigurator {

	//default to the EE8 feature
	static String jsonp11 = "jsonp-1.1";
    ...
    public void setFeatureString(String featureStr){
    	...
    	if (featureStr.equals(BoosterPacksParent.JSONP_BOOSTER_PACK_STRING_20 )) {
    		featureGAV = jsonp11;
